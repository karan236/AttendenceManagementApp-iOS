//
//  AttendenceRecordOfAStudentViewController.m
//  AttendenceManangent
//
//  Created by Karan Ghorai on 26/06/21.
//

#import "AttendenceRecordOfAStudentViewController.h"
#import "../../Models/AttendenceRecordModel/AttendenceRecord+CoreDataClass.h"

@interface AttendenceRecordOfAStudentViewController ()
...
@implementation AttendenceRecordOfAStudentViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UILabel *attendenceLabel = [cell viewWithTag:2];
...
- (IBAction)showRecordButtonAction:(id)sender {
